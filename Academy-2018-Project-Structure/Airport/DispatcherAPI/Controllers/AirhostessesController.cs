...
namespace DAL.Controllers
{
    ...
    public class AirhostessesController : Controller
    {
        ...
        [HttpPost]
        public void Post(string firstname, string lastname, DateTime birthday)
        {
            (service as HostessesService).Create(firstname, lastname, birthday);

        }

        // PUT: api/Airhostesses/5
        [HttpPut("{id}")]
        public void Put(string firstname, string lastname, DateTime birthday,  int id)
        {
            (service as HostessesService).Update(firstname, lastname, birthday, id);
