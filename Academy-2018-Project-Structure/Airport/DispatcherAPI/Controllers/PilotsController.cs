...
namespace DAL.Controllers
{
    ...
    public class PilotsController : Controller
    {
        ...
        // POST: api/Pilots
        [HttpPost]
        public void Post(string firstname, string lastname, DateTime birthday, TimeSpan experience)
        {
        ...
        // PUT: api/Pilots/5
        [HttpPut("{id}")]
        public void Put(string firstname, string lastname, DateTime birthday, TimeSpan experience, int id)
        {
        ...
        // PATCH: api/Pilots/5
        [HttpPatch("{id}")]
        public void Patch(int id, TimeSpan experience)
        {
