   ...
   public class DBInitializer
    {
        ...
        public static List<Airplane> GetAirplanes()
        {
            var plane1 = new Airplane
            {
                ...
                Lifetime = new TimeSpan(1825, 0, 0, 0).Ticks
            };
            ...
            var plane2 = new Airplane
            {
                ...
                Lifetime = new TimeSpan(1, 0, 0, 0).Ticks
            };
            ...
            var plane4 = new Airplane
            {
                Name = "UR-88888",
                CreationDate = new DateTime(2012, 6, 14),
                Lifetime = new TimeSpan(2555, 0, 0, 0).Ticks
            };
        ...
        public static List<Pilot> GetPilots()
        {
            var pilot1 = new Pilot
            {
                ...
                Experience = new TimeSpan(1820, 0, 0, 0).Ticks
            };
            ...
            var pilot2 = new Pilot
            {
                ...
                Experience = new TimeSpan(3650, 0, 0, 0).Ticks
            };
            ...
            var pilot3 = new Pilot
            {
                ...
                Experience = new TimeSpan(1825, 0, 0, 0).Ticks
            };
