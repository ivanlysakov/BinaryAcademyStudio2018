...
namespace DAL.Repository.EF
{
    public static class AirportContextExtensionsSeeds
    {
        public static void EnsureDatabaseSeeded(this AirportContext context)
        {
            ...
            context.AddRange(new List<Departure> { dep1, dep2, dep3 });
            context.SaveChanges();
            
            Crew crew1 = new Crew { CrewNumber = 222, DepartureID = dep1.Id };
            Crew crew2 = new Crew { CrewNumber = 665, DepartureID = dep2.Id };
            ...
            context.AddRange(new List<Airplane> { airplane1, airplane2, airplane3 });
            context.SaveChanges();
            ...
            context.AddRange(new List<AirplaneType> { type1, type2, type3 });
            context.SaveChanges();
        }
    }
}
