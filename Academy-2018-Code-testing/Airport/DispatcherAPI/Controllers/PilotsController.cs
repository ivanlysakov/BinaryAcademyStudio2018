...
namespace DAL.Controllers
{
    ...
    public class PilotsController : Controller
    {
        ...
        // POST: api/Pilots
        [HttpPost]
        public void Post(string firstname, string lastname, DateTime birthday, int experience, int crew)
        {
            (service as PilotsService).Create(firstname, lastname, birthday, experience,crew);
