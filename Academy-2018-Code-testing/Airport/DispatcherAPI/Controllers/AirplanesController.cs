...
namespace DAL.Controllers
{
    ...
    public class AirplanesController : Controller
    {
        ...
        // POST: api/Airplanes
        [HttpPost]
        public void Post(string name, DateTime creationDate, int lifetime, int type)
        {
        ...
        // PUT: api/Airplanes/5
        [HttpPut("{id}")]
        public void Put(string name, DateTime creationDate, int lifetime, int type, int id)
        {
        ...
        [HttpPatch("{id}")]
        public void Patch(int id, int lifetime)
        {
